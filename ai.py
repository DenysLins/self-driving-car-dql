...
class Network(nn.Module):
    ...
    def __init__(self, input_size, nb_action):
        ...
        self.num_neurons_1 = 60
        self.num_neurons_2 = 30

        self.full_connection_1 = nn.Linear(input_size, self.num_neurons_1)
        self.full_connection_2 = nn.Linear(
            self.num_neurons_1, self.num_neurons_2)
        self.full_connection_3 = nn.Linear(self.num_neurons_2, nb_action)
